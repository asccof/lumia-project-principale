...
admin_bp = Blueprint('admin', **name**, template_folder='templates', static_folder=None)
...
"[ADMIN][NOTIF][EMAIL] Configuration SMTP incomplète (EMAIL** / MAIL_*). "
...
ProfessionalOrder.**table**.create(bind=db.engine, checkfirst=True)
...
@admin_bp.route('/products/edit/[int:product_id](int:product_id)', methods=['GET', 'POST'], endpoint='admin_edit_product')
@login_required
...
@admin_bp.route('/products/[int:product_id](int:product_id)/delete', methods=['POST'], endpoint='admin_delete_product')
@login_required
...
@admin_bp.route('/professionals/edit/[int:professional_id](int:professional_id)', methods=['GET', 'POST'], endpoint='edit_professional')
@login_required
...
@admin_bp.route('/professionals/delete/[int:professional_id](int:professional_id)', methods=['GET', 'POST'], endpoint='delete_professional')
@login_required
...
@admin_bp.route('/professionals/[int:professional_id](int:professional_id)', endpoint='view_professional')
@login_required
...
@admin_bp.route('/professionals/[int:professional_id](int:professional_id)/availability', methods=['GET', 'POST'], endpoint='admin_professional_availability')
@login_required
...
@admin_bp.route('/professionals/[int:professional_id](int:professional_id)/unavailable-slots', methods=['GET', 'POST'], endpoint='admin_professional_unavailable_slots')
@login_required
...
@admin_bp.route('/professionals/[int:professional_id](int:professional_id)/unavailable-slots/[int:slot_id](int:slot_id)/delete', methods=['POST'], endpoint='admin_delete_unavailable_slot')
@login_required
...
placeholder_email = "[deleted@tighri.local](mailto:deleted@tighri.local)"
...
@admin_bp.route('/users/edit/[int:user_id](int:user_id)', methods=['GET', 'POST'], endpoint='edit_user')
@login_required
...
@admin_bp.route('/users/delete/[int:user_id](int:user_id)', methods=['GET', 'POST'], endpoint='delete_user')
@login_required
...
@admin_bp.route('/orders/[int:appointment_id](int:appointment_id)/status', methods=['POST'], endpoint='update_appointment_status')
@login_required
...
@admin_bp.route('/professionals/[int:professional_id](int:professional_id)/validate', methods=['POST'], endpoint='validate_professional')
@login_required
...
@admin_bp.route('/professionals/[int:professional_id](int:professional_id)/reject', methods=['POST'], endpoint='reject_professional')
@login_required
...
@admin_bp.route('/professionals/[int:professional_id](int:professional_id)/social-approval', methods=['POST'], endpoint='social_approval')
@login_required
