...
# ================== MODÈLES ==================
# ⚠️ Renommer les tables pour éviter "user" (mot réservé Postgres)
...
class Appointment(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    patient_id = db.Column(db.Integer, db.ForeignKey('users.id'), nullable=False)           # <- users
    professional_id = db.Column(db.Integer, db.ForeignKey('professionals.id'), nullable=False)  # <- professionals
